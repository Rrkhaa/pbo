...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            if (mainChoice == 1) {
                // Menu untuk Member
                handleMemberMenu(libraryService, scanner);
            } else if (mainChoice == 2) {
                // Menu untuk Petugas Perpustakaan
                handleLibrarianMenu(libraryService, scanner);
    ...
    // Metode untuk menangani menu Member
    private static void handleMemberMenu(LibraryService libraryService, Scanner scanner) {
        int choice;
        do {
            System.out.println("\n=== Menu Member ===");
    ...
    // Metode untuk menangani menu Petugas Perpustakaan
    private static void handleLibrarianMenu(LibraryService libraryService, Scanner scanner) {
        int choice;
        do {
